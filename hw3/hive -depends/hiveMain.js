...
// main.js
  ...
  var get_info  = function(data_set, format) {
    ...
    var degree  = Math.PI / 180,
        x_max   = 900,    x_off   = x_max * 0.5,
        y_max   = 1000,    y_off   = y_max * 0.25;
  ...
  var data_sets     = { '#demo_2':   'architecture.json' };
...
var setup_mouse = function(plot_info) {
  ...
  // Helper for on_mouseover_{link,node}.
    ...
    if (css_class == 'ib')
      hdr  = '<h4 class="ib">Serves to:</h4>';
    else
      hdr  = '<h4 class="im">Is dependent on:</h4>';
